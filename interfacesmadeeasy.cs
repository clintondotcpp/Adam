...
public class Player : MonoBehaviour, IDamagable, IShoot //// interfaces allows multiple inheritance, in this case, it forces a universal health system on each player,
...
public class Enemy : MonoBehaviour, IDamagable, IShoot  //// interfaces allows multiple inheritance, in this case, it forces a universal health system on each player,
                                                        //you can have several interfaces, it simulates a plug in play environment
{
    public int Health
    {
